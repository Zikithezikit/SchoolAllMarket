...
{
    bool Filter = false; // בודק האם צריך להראות את כל המוצרים או רק כמה
    protected void Page_Load(object sender, EventArgs e)
    {

        if (Session["userName"] == null)
        {
            lbl_Welcome.Text = "ברוך הבא אורח";
            btn_logout.Visible = false;
            btn_UpdateUserInfo.Visible = false;
            btn_uploadProduct.Visible = false;
            btn_MyProducts.Visible = false;
            btn_ForgotCredit.Visible = false;
            lbl_UserName.Text = "guest";
        }
        else
        {
            users us = new users();
            lbl_Welcome.Text = Session["userName"].ToString() + " ברוך הבא " ;
            lbl_UserName.Text = Session["userName"].ToString();
            //lbl_UserName.Text = "yy";
            btn_logout.Visible = true;
            if (us.Isadmin(Session["userName"].ToString()))
            {
                btn_Admin_goto.Visible = true;
                lbl_Welcome.Text = "Welcome Admin " + Session["userName"].ToString();
            }
    ...
    public void BlockFilter()
    {
        ...
        grd_AllProducts.DataSource = filteProducts.FilterProducts(ddl_Category.SelectedValue.ToString(),ddl_Condition.SelectedValue.ToString());
    ...
    {
        Response.Redirect("./GetCreditUsingId.aspx");
    }
}